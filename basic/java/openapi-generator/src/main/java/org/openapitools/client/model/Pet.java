...
public class Pet {
  ...
  **/
  ...
  public Pet petType(PetPetType petType) {
  ...
  **/
  ...
  public PetPetType getPetType() {
    return petType;
  }


  public void setPetType(PetPetType petType) {
    this.petType = petType;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, petType);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `petType`
      if (jsonObj.get("petType") != null && !jsonObj.get("petType").isJsonNull()) {
        PetPetType.validateJsonElement(jsonObj.get("petType"));
      }
  }

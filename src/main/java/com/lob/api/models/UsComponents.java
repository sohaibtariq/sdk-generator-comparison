...
public class UsComponents {
     ...
     * @param  zipCodePlus4  String value for zipCodePlus4.
    ...
    protected UsComponents(String primaryNumber, StreetPredirectionEnum streetPredirection,
            ...
            String city, String state, String zipCode, String zipCodePlus4,
     ...
     * @param zipCodePlus4 Value for String
     */
     ...
     * target="_blank"&gt;Residential Delivery Indicator (RDI)&lt;/a&gt; to identify whether an address is
     * classified as residential or business. Possible values are: * `residential` –– The address is
     * residential or a PO Box. * `commercial` –– The address is commercial. * `''` –– Not enough
     ...
     * A 5-digit &lt;a href="https://en.wikipedia.org/wiki/FIPS_county_code" target="_blank"&gt;FIPS
     * county code&lt;/a&gt; which uniquely identifies `components[county]`. It consists of a 2-digit
     * state code and a 3-digit county code.
     * @return Returns the String
     */
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder zipCodePlus4(String zipCodePlus4) {
            this.zipCodePlus4 = zipCodePlus4;
            return this;
        }

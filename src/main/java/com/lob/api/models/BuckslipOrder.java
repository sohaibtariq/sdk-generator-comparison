...
/**
 * This is a model class for BuckslipOrder type.
 */
public class BuckslipOrder {
     ...
     * @param  buckslipId  String value for buckslipId.
    ...
    /**
     * Getter for BuckslipId.
     * Unique identifier prefixed with `bck_`.
     * @return Returns the String
     */
    @JsonGetter("buckslip_id")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    ...
    /**
     * Setter for BuckslipId.
     * Unique identifier prefixed with `bck_`.
     * @param buckslipId Value for String
     */
    @JsonSetter("buckslip_id")
    ...
    /**
     * Converts this BuckslipOrder into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BuckslipOrder [" + "dateCreated=" + dateCreated + ", dateModified=" + dateModified
                + ", object=" + object + ", deleted=" + deleted + ", id=" + id + ", buckslipId="
                + buckslipId + ", status=" + status + ", quantityOrdered=" + quantityOrdered
                + ", unitPrice=" + unitPrice + ", inventory=" + inventory + ", cancelledReason="
                + cancelledReason + ", availabilityDate=" + availabilityDate
                + ", expectedAvailabilityDate=" + expectedAvailabilityDate + "]";
    }

    /**
     * Builds a new {@link BuckslipOrder.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BuckslipOrder.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(dateCreated, dateModified, object)
                .deleted(getDeleted())
                .id(getId())
                .buckslipId(getBuckslipId())
                .status(getStatus())
    ...
    /**
     * Class to build instances of {@link BuckslipOrder}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder buckslipId(String buckslipId) {
            this.buckslipId = buckslipId;
            return this;
        }
        ...
        /**
         * Builds a new {@link BuckslipOrder} object using the set fields.
         * @return {@link BuckslipOrder}
         */
        public BuckslipOrder build() {
            return new BuckslipOrder(dateCreated, dateModified, object, deleted, id, buckslipId,
                    status, quantityOrdered, unitPrice, inventory, cancelledReason,
                    availabilityDate, expectedAvailabilityDate);
        }
    }
}

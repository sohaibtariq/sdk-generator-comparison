...
public class CheckBase {
    ...
    private OptionalNullable<ChkUseTypeEnum> useType;
    ...
    protected CheckBase(OptionalNullable<String> description, Map<String, String> metadata,
            ...
            OptionalNullable<ChkUseTypeEnum> useType) {
     ...
     * @return Returns the Internal ChkUseTypeEnum
     */
    @JsonGetter("use_type")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonSerialize(using = OptionalNullable.Serializer.class)
    protected OptionalNullable<ChkUseTypeEnum> internalGetUseType() {
        return this.useType;
    }

...
public class AllSelfMailers {
    ...
    protected AllSelfMailers(String object, OptionalNullable<String> nextUrl,
    ...
    public String toString() {
        return "AllSelfMailers [" + "object=" + object + ", nextUrl=" + nextUrl + ", previousUrl="
    ...
    public static class Builder {
        ...
        public AllSelfMailers build() {
            return new AllSelfMailers(object, nextUrl, previousUrl, count, totalCount, data);
        }
    }
}

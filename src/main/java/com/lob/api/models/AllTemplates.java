...
public class AllTemplates {
    ...
    protected AllTemplates(String object, OptionalNullable<String> nextUrl,
    ...
    public String toString() {
        return "AllTemplates [" + "object=" + object + ", nextUrl=" + nextUrl + ", previousUrl="
    ...
    public static class Builder {
        ...
        public AllTemplates build() {
            return new AllTemplates(object, nextUrl, previousUrl, count, totalCount, data);
        }
    }
}

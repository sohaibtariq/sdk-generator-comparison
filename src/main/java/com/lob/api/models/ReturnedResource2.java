...
/**
 * This is a model class for ReturnedResource2 type.
 */
public class ReturnedResource2 {
    private String resourceType;
    private SelfMailerDetailsReturned details;
     ...
     * @param  details  SelfMailerDetailsReturned value for details.
    ...
    public ReturnedResource2(
            String resourceType,
            SelfMailerDetailsReturned details,
            FromAttribute from,
            String description,
    ...
    protected ReturnedResource2(String resourceType, SelfMailerDetailsReturned details,
     ...
     * @return Returns the SelfMailerDetailsReturned
     */
    @JsonGetter("details")
    public SelfMailerDetailsReturned getDetails() {
        return details;
    }
     ...
     * Properties that the self mailers in your Creative should have. Check within in order to add a
     * QR code to your creative.
     * @param details Value for SelfMailerDetailsReturned
     */
    @JsonSetter("details")
    public void setDetails(SelfMailerDetailsReturned details) {
        this.details = details;
    }
    ...
    /**
     * Converts this ReturnedResource2 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReturnedResource2 [" + "resourceType=" + resourceType + ", details=" + details
                + ", from=" + from + ", description=" + description + ", metadata=" + metadata
                + "]";
    }

    /**
     * Builds a new {@link ReturnedResource2.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReturnedResource2.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(resourceType, details)
                .from(getFrom())
    ...
    /**
     * Class to build instances of {@link ReturnedResource2}.
     */
    public static class Builder {
         ...
         * @param  details  SelfMailerDetailsReturned value for details.
         */
        public Builder(String resourceType, SelfMailerDetailsReturned details) {
            this.resourceType = resourceType;
            this.details = details;
        }
         ...
         * @return Builder
         */
        public Builder details(SelfMailerDetailsReturned details) {
            this.details = details;
            return this;
        }
        ...
        /**
         * Builds a new {@link ReturnedResource2} object using the set fields.
         * @return {@link ReturnedResource2}
         */
        public ReturnedResource2 build() {
            return new ReturnedResource2(resourceType, details, from, description, metadata);
        }
    }
}

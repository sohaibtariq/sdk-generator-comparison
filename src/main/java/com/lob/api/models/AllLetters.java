...
public class AllLetters {
     ...
     * @param  data  List of Letter value for data.
     */
    public AllLetters(
            String object,
            String nextUrl,
     ...
     * Getter for Data.
     * list of letters
     * @return Returns the List of Letter
     */
    @JsonGetter("data")
    @JsonInclude(JsonInclude.Include.NON_NULL)
     ...
     * Setter for Data.
     * list of letters
     * @param data Value for List of Letter
     */
    @JsonSetter("data")
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder data(List<Letter> data) {
            this.data = data;
            return this;
        }
        ...
        public AllLetters build() {
            return new AllLetters(object, nextUrl, previousUrl, count, totalCount, data);
        }
    }
}

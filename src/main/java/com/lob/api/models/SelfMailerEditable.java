...
import com.lob.api.models.containers.SelfMailerEditableFrom;
import com.lob.api.models.containers.SelfMailerEditableInside;
import com.lob.api.models.containers.SelfMailerEditableOutside;
import com.lob.api.models.containers.SelfMailerEditableTo;
...
public class SelfMailerEditable {
    ...
    private SelfMailerEditableTo to;
    private SelfMailerEditableFrom from;
    private SelfMailerEditableInside inside;
    private SelfMailerEditableOutside outside;
     ...
     * @param  to  SelfMailerEditableTo value for to.
     * @param  inside  SelfMailerEditableInside value for inside.
     * @param  outside  SelfMailerEditableOutside value for outside.
     ...
     * @param  from  SelfMailerEditableFrom value for from.
    ...
    protected SelfMailerEditable(SelfMailerEditableTo to, SelfMailerEditableInside inside,
            SelfMailerEditableOutside outside, SfmUseTypeEnum useType,
            ...
            SelfMailerSizeEnum size, SelfMailerEditableFrom from, String billingGroupId,
            QrCode qrCode, Boolean fsc) {
     ...
     * @return Returns the SelfMailerEditableTo
     */
    @JsonGetter("to")
    public SelfMailerEditableTo getTo() {
        return to;
    }
     ...
     * href="https://help.lob.com/print-and-mail/all-about-addresses" target="_blank"&gt;Lob Guide:
     * Verification of Mailing Addresses&lt;/a&gt;
     * @param to Value for SelfMailerEditableTo
     */
    @JsonSetter("to")
    public void setTo(SelfMailerEditableTo to) {
        this.to = to;
    }
     ...
     * @return Returns the SelfMailerEditableFrom
     */
    @JsonGetter("from")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public SelfMailerEditableFrom getFrom() {
        return from;
    }
     ...
     * correct address parameters. All addresses will be standardized into uppercase without being
     * modified by verification.
     * @param from Value for SelfMailerEditableFrom
     */
    @JsonSetter("from")
    public void setFrom(SelfMailerEditableFrom from) {
        this.from = from;
    }
     ...
     * address and postage information by following the templates provided here: - &lt;a
     ...
     * href="https://s3-us-west-2.amazonaws.com/public.lob.com/assets/templates/self_mailers/17_75x9_trifold_sfm_template.pdf"
     * target="_blank"&gt;17.75x9 trifold template&lt;/a&gt; See [here](#section/HTML-Examples) for HTML
     * examples.
     * @return Returns the SelfMailerEditableInside
     */
    @JsonGetter("inside")
    public SelfMailerEditableInside getInside() {
        return inside;
    }
     ...
     * target="_blank"&gt;17.75x9 trifold template&lt;/a&gt; See [here](#section/HTML-Examples) for HTML
     * examples.
     * @param inside Value for SelfMailerEditableInside
     */
    @JsonSetter("inside")
    public void setInside(SelfMailerEditableInside inside) {
        this.inside = inside;
    }
     ...
     * @return Returns the SelfMailerEditableOutside
     */
    @JsonGetter("outside")
    public SelfMailerEditableOutside getOutside() {
        return outside;
    }
     ...
     * while supplied HTML will be rendered to the specified `size`. See
     * [here](#section/HTML-Examples) for HTML examples.
     * @param outside Value for SelfMailerEditableOutside
     */
    @JsonSetter("outside")
    public void setOutside(SelfMailerEditableOutside outside) {
        this.outside = outside;
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(to, inside, outside, useType)
    ...
    public static class Builder {
         ...
         * @param  useType  SfmUseTypeEnum value for useType.
         */
        public Builder(SelfMailerEditableTo to, SelfMailerEditableInside inside,
                SelfMailerEditableOutside outside, SfmUseTypeEnum useType) {
            this.to = to;
            this.inside = inside;
            this.outside = outside;
         ...
         * @return Builder
         */
        public Builder to(SelfMailerEditableTo to) {
            this.to = to;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder inside(SelfMailerEditableInside inside) {
            this.inside = inside;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder outside(SelfMailerEditableOutside outside) {
            this.outside = outside;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder from(SelfMailerEditableFrom from) {
            this.from = from;
            return this;
        }
        ...
        public SelfMailerEditable build() {
            return new SelfMailerEditable(to, inside, outside, useType, description, metadata,
                    mailType, mergeVariables, sendDate, size, from, billingGroupId, qrCode, fsc);
        }
    }
}

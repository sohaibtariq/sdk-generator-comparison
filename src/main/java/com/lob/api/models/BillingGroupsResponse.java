...
public class BillingGroupsResponse {
    ...
    protected BillingGroupsResponse(String object, OptionalNullable<String> nextUrl,
    ...
    public String toString() {
        return "BillingGroupsResponse [" + "object=" + object + ", nextUrl=" + nextUrl
    ...
    public static class Builder {
        ...
        public BillingGroupsResponse build() {
            return new BillingGroupsResponse(object, nextUrl, previousUrl, count, totalCount, data);
        }
    }
}

...
/**
 * This is a model class for CampaignItem type.
 */
public class CampaignItem {
     ...
     * @param  creatives  List of String value for creatives.
     * @param  uploads  List of String value for uploads.
    ...
    protected CampaignItem(String name, String description, String scheduleType,
            CmpUseTypeEnum useType, boolean autoCancelIfNcoa, String id, boolean isDraft,
            List<String> creatives, List<String> uploads, String object, LocalDateTime dateCreated,
            LocalDateTime dateModified, OptionalNullable<String> billingGroupId,
     ...
     * An array of creatives that have been associated with this campaign.
     * @param creatives Value for List of String
     */
     ...
     * Setter for Uploads.
     * A single-element array containing the upload object that is assocated with this campaign.
     * @param uploads Value for List of String
     */
    @JsonSetter("uploads")
    ...
    /**
     * Converts this CampaignItem into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CampaignItem [" + "name=" + name + ", description=" + description
                + ", scheduleType=" + scheduleType + ", useType=" + useType + ", autoCancelIfNcoa="
                + autoCancelIfNcoa + ", id=" + id + ", isDraft=" + isDraft + ", creatives="
                + creatives + ", uploads=" + uploads + ", object=" + object + ", dateCreated="
                + dateCreated + ", dateModified=" + dateModified + ", billingGroupId="
    ...
    /**
     * Builds a new {@link CampaignItem.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CampaignItem.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(name, description, scheduleType, useType, autoCancelIfNcoa,
                id, isDraft, creatives, uploads, object, dateCreated, dateModified)
    ...
    /**
     * Class to build instances of {@link CampaignItem}.
     */
    public static class Builder {
         ...
         * @param  dateModified  LocalDateTime value for dateModified.
         */
        public Builder(String name, String description, String scheduleType, CmpUseTypeEnum useType,
                boolean autoCancelIfNcoa, String id, boolean isDraft, List<String> creatives,
                List<String> uploads, String object, LocalDateTime dateCreated,
                LocalDateTime dateModified) {
            this.name = name;
            this.description = description;
            this.scheduleType = scheduleType;
         ...
         * @return Builder
         */
        public Builder creatives(List<String> creatives) {
            this.creatives = creatives;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder uploads(List<String> uploads) {
            this.uploads = uploads;
            return this;
        }
        ...
        /**
         * Builds a new {@link CampaignItem} object using the set fields.
         * @return {@link CampaignItem}
         */
        public CampaignItem build() {
            return new CampaignItem(name, description, scheduleType, useType, autoCancelIfNcoa, id,
                    isDraft, creatives, uploads, object, dateCreated, dateModified, billingGroupId,
                    targetDeliveryDate, sendDate, cancelWindowCampaignMinutes, metadata, deleted);
        }
    }
}

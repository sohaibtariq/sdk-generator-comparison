...
import com.lob.api.models.containers.ImageAtCheckBottomAttachment;
import com.lob.api.models.containers.ImageAtCheckBottomFrom;
import com.lob.api.models.containers.ImageAtCheckBottomLogo;
import com.lob.api.models.containers.ImageAtCheckBottomTo;
import com.lob.api.models.containers.SendDate;
import io.apimatic.core.types.OptionalNullable;
import java.util.Map;

/**
 * This is a model class for ImageAtCheckBottom type.
 */
public class ImageAtCheckBottom {
    ...
    private ImageAtCheckBottomTo to;
    private ImageAtCheckBottomFrom from;
    private String bankAccount;
    private double amount;
    private ImageAtCheckBottomLogo logo;
    private CheckBottom checkBottom;
    private ImageAtCheckBottomAttachment attachment;
     ...
     * @param  to  ImageAtCheckBottomTo value for to.
     * @param  from  ImageAtCheckBottomFrom value for from.
     ...
     * @param  logo  ImageAtCheckBottomLogo value for logo.
     * @param  attachment  ImageAtCheckBottomAttachment value for attachment.
    ...
    public ImageAtCheckBottom(
            ...
            Integer checkNumber,
            String message,
            ImageAtCheckBottomLogo logo,
            ImageAtCheckBottomAttachment attachment,
    ...
    protected ImageAtCheckBottom(ChkUseTypeEnum useType, ImageAtCheckBottomTo to,
            ImageAtCheckBottomFrom from, String bankAccount, double amount, CheckBottom checkBottom,
            ...
            ImageAtCheckBottomLogo logo, ImageAtCheckBottomAttachment attachment,
            String billingGroupId) {
     ...
     */
    @JsonCreator
    protected ImageAtCheckBottom(
            @JsonProperty("use_type") ChkUseTypeEnum useType,
            @JsonProperty("to") ImageAtCheckBottomTo to,
            @JsonProperty("from") ImageAtCheckBottomFrom from,
            @JsonProperty("bank_account") String bankAccount,
            @JsonProperty("amount") double amount,
            @JsonProperty("check_bottom") CheckBottom checkBottom) {
        this(useType, to, from, bankAccount, amount, checkBottom, OptionalNullable.of(null), null,
                OptionalNullable.of(null), null, null, OptionalNullable.of(null), null, null, null,
                null, null);
        unsetDescription();
        unsetMergeVariables();
        unsetMemo();
     ...
     * @return Returns the ImageAtCheckBottomTo
     */
    @JsonGetter("to")
    public ImageAtCheckBottomTo getTo() {
        return to;
    }
     ...
     * href="https://help.lob.com/print-and-mail/all-about-addresses" target="_blank"&gt;More about
     * verification of mailing addresses&lt;/a&gt;
     * @param to Value for ImageAtCheckBottomTo
     */
    @JsonSetter("to")
    public void setTo(ImageAtCheckBottomTo to) {
        this.to = to;
    }
     ...
     * @return Returns the ImageAtCheckBottomFrom
     */
    @JsonGetter("from")
    public ImageAtCheckBottomFrom getFrom() {
        return from;
    }
     ...
     * be an address ID or an inline object with correct address parameters. All addresses will be
     * standardized into uppercase without being modified by verification.
     * @param from Value for ImageAtCheckBottomFrom
     */
    @JsonSetter("from")
    public void setFrom(ImageAtCheckBottomFrom from) {
        this.from = from;
    }
     ...
     * @return Returns the ImageAtCheckBottomLogo
     */
    @JsonGetter("logo")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ImageAtCheckBottomLogo getLogo() {
        return logo;
    }
     ...
     * upper-left corner of your check. Image requirements: * RGB or CMYK * square * minimum size:
     * 100px x 100px * transparent backgrond * `png` or `jpg`
     * @param logo Value for ImageAtCheckBottomLogo
     */
    @JsonSetter("logo")
    public void setLogo(ImageAtCheckBottomLogo logo) {
        this.logo = logo;
    }
     ...
     * @return Returns the ImageAtCheckBottomAttachment
     */
    @JsonGetter("attachment")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ImageAtCheckBottomAttachment getAttachment() {
        return attachment;
    }
     ...
     * href="https://lob.com/pricing/print-mail#compare" target="_blank"&gt;pricing&lt;/a&gt; for extra costs
     * incurred. Need more help? Consult our [HTML examples](#section/HTML-Examples).
     * @param attachment Value for ImageAtCheckBottomAttachment
     */
    @JsonSetter("attachment")
    public void setAttachment(ImageAtCheckBottomAttachment attachment) {
        this.attachment = attachment;
    }
    ...
    /**
     * Converts this ImageAtCheckBottom into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ImageAtCheckBottom [" + "useType=" + useType + ", to=" + to + ", from=" + from
                + ", bankAccount=" + bankAccount + ", amount=" + amount + ", checkBottom="
                + checkBottom + ", description=" + description + ", metadata=" + metadata
                + ", mergeVariables=" + mergeVariables + ", sendDate=" + sendDate + ", mailType="
                + mailType + ", memo=" + memo + ", checkNumber=" + checkNumber + ", message="
                + message + ", logo=" + logo + ", attachment=" + attachment + ", billingGroupId="
                + billingGroupId + "]";
    }

    /**
     * Builds a new {@link ImageAtCheckBottom.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ImageAtCheckBottom.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(useType, to, from, bankAccount, amount, checkBottom)
    ...
    /**
     * Class to build instances of {@link ImageAtCheckBottom}.
     */
    public static class Builder {
         ...
         * @param  checkBottom  CheckBottom value for checkBottom.
         */
        public Builder(ChkUseTypeEnum useType, ImageAtCheckBottomTo to, ImageAtCheckBottomFrom from,
                String bankAccount, double amount, CheckBottom checkBottom) {
            this.useType = useType;
            this.to = to;
            this.from = from;
            this.bankAccount = bankAccount;
         ...
         * @return Builder
         */
        public Builder to(ImageAtCheckBottomTo to) {
            this.to = to;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder from(ImageAtCheckBottomFrom from) {
            this.from = from;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder logo(ImageAtCheckBottomLogo logo) {
            this.logo = logo;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder attachment(ImageAtCheckBottomAttachment attachment) {
            this.attachment = attachment;
            return this;
        }
        ...
        /**
         * Builds a new {@link ImageAtCheckBottom} object using the set fields.
         * @return {@link ImageAtCheckBottom}
         */
        public ImageAtCheckBottom build() {
            return new ImageAtCheckBottom(useType, to, from, bankAccount, amount, checkBottom,
                    description, metadata, mergeVariables, sendDate, mailType, memo, checkNumber,
                    message, logo, attachment, billingGroupId);
        }
    }
}

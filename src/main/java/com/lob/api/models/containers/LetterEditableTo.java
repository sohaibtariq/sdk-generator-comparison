 ...
 */
@JsonDeserialize(using = LetterEditableTo.LetterEditableToDeserializer.class)
public abstract class LetterEditableTo {
     ...
     */
    public static LetterEditableTo fromMString(String mString) {
    ...
    private static class MStringCase extends LetterEditableTo {
    ...
    private static class Case1 extends LetterEditableTo {
    ...
    /**
     * This is a custom deserializer class for LetterEditableTo.
     */
    protected static class LetterEditableToDeserializer
            extends JsonDeserializer<LetterEditableTo> {

        @Override
        public LetterEditableTo deserialize(JsonParser jp, DeserializationContext ctxt)

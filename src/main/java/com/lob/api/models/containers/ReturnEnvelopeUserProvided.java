 ...
 */
@JsonDeserialize(using = ReturnEnvelopeUserProvided.ReturnEnvelopeUserProvidedDeserializer.class)
public abstract class ReturnEnvelopeUserProvided {
     ...
     */
    public static ReturnEnvelopeUserProvided fromMBoolean(boolean mBoolean) {
     ...
     */
    public static ReturnEnvelopeUserProvided fromMString(String mString) {
    ...
    private static class MBooleanCase extends ReturnEnvelopeUserProvided {
    ...
    private static class MStringCase extends ReturnEnvelopeUserProvided {
    ...
    /**
     * This is a custom deserializer class for ReturnEnvelopeUserProvided.
     */
    protected static class ReturnEnvelopeUserProvidedDeserializer
            extends JsonDeserializer<ReturnEnvelopeUserProvided> {

        @Override
        public ReturnEnvelopeUserProvided deserialize(JsonParser jp, DeserializationContext ctxt)

 ...
 */
@JsonDeserialize(using = CrvBack.CrvBackDeserializer.class)
public abstract class CrvBack {
     ...
     */
    public static CrvBack fromMString(String mString) {
    ...
    private static class MStringCase extends CrvBack {
    ...
    /**
     * This is a custom deserializer class for CrvBack.
     */
    protected static class CrvBackDeserializer
            extends JsonDeserializer<CrvBack> {

        @Override
        public CrvBack deserialize(JsonParser jp, DeserializationContext ctxt)

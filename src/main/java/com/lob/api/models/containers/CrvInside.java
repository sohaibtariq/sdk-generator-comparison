 ...
 */
@JsonDeserialize(using = CrvInside.CrvInsideDeserializer.class)
public abstract class CrvInside {
     ...
     */
    public static CrvInside fromMString(String mString) {
    ...
    private static class MStringCase extends CrvInside {
    ...
    /**
     * This is a custom deserializer class for CrvInside.
     */
    protected static class CrvInsideDeserializer
            extends JsonDeserializer<CrvInside> {

        @Override
        public CrvInside deserialize(JsonParser jp, DeserializationContext ctxt)

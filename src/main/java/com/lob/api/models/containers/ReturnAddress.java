 ...
 */
@JsonDeserialize(using = ReturnAddress.ReturnAddressDeserializer.class)
public abstract class ReturnAddress {
     ...
     */
    public static ReturnAddress fromMString(String mString) {
     ...
     */
    public static ReturnAddress fromInlineAddress(InlineAddress inlineAddress) {
    ...
    private static class MStringCase extends ReturnAddress {
    ...
    private static class Case1 extends ReturnAddress {
    ...
    /**
     * This is a custom deserializer class for ReturnAddress.
     */
    protected static class ReturnAddressDeserializer
            extends JsonDeserializer<ReturnAddress> {

        @Override
        public ReturnAddress deserialize(JsonParser jp, DeserializationContext ctxt)

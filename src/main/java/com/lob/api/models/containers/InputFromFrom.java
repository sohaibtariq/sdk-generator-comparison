 ...
 */
@JsonDeserialize(using = InputFromFrom.InputFromFromDeserializer.class)
public abstract class InputFromFrom {
     ...
     */
    public static InputFromFrom fromMString(String mString) {
    ...
    private static class MStringCase extends InputFromFrom {
    ...
    private static class Case1 extends InputFromFrom {
    ...
    /**
     * This is a custom deserializer class for InputFromFrom.
     */
    protected static class InputFromFromDeserializer
            extends JsonDeserializer<InputFromFrom> {

        @Override
        public InputFromFrom deserialize(JsonParser jp, DeserializationContext ctxt)

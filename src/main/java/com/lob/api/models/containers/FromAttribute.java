 ...
 */
@JsonDeserialize(using = FromAttribute.FromAttributeDeserializer.class)
public abstract class FromAttribute {
     ...
     */
    public static FromAttribute fromMString(String mString) {
     ...
     */
    public static FromAttribute fromInlineAddressUs(InlineAddressUs inlineAddressUs) {
    ...
    private static class MStringCase extends FromAttribute {
    ...
    private static class InlineAddressUsCase extends FromAttribute {
    ...
    /**
     * This is a custom deserializer class for FromAttribute.
     */
    protected static class FromAttributeDeserializer
            extends JsonDeserializer<FromAttribute> {

        @Override
        public FromAttribute deserialize(JsonParser jp, DeserializationContext ctxt)

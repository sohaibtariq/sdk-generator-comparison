 ...
 */
@JsonDeserialize(using = InputToTo.InputToToDeserializer.class)
public abstract class InputToTo {
     ...
     */
    public static InputToTo fromMString(String mString) {
    ...
    private static class MStringCase extends InputToTo {
    ...
    private static class Case1 extends InputToTo {
    ...
    /**
     * This is a custom deserializer class for InputToTo.
     */
    protected static class InputToToDeserializer
            extends JsonDeserializer<InputToTo> {

        @Override
        public InputToTo deserialize(JsonParser jp, DeserializationContext ctxt)

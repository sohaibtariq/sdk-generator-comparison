 ...
 */
@JsonDeserialize(using = ValidationErrorLoc.ValidationErrorLocDeserializer.class)
public abstract class ValidationErrorLoc {
     ...
     */
    public static ValidationErrorLoc fromMString(String mString) {
    ...
    private static class MStringCase extends ValidationErrorLoc {
    ...
    private static class NumberCase extends ValidationErrorLoc {
    ...
    /**
     * This is a custom deserializer class for ValidationErrorLoc.
     */
    protected static class ValidationErrorLocDeserializer
            extends JsonDeserializer<ValidationErrorLoc> {

        @Override
        public ValidationErrorLoc deserialize(JsonParser jp, DeserializationContext ctxt)
                throws IOException, JsonProcessingException {
            ObjectCodec oc = jp.getCodec();
            JsonNode node = oc.readTree(jp);
            return ApiHelper.deserialize(node, Arrays.asList(MStringCase.class,
                    NumberCase.class), false);
        }
    }

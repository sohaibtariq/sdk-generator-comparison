 ...
 */
@JsonDeserialize(using = CheckBottom.CheckBottomDeserializer.class)
public abstract class CheckBottom {
     ...
     */
    public static CheckBottom fromMString(String mString) {
    ...
    private static class MStringCase extends CheckBottom {
    ...
    /**
     * This is a custom deserializer class for CheckBottom.
     */
    protected static class CheckBottomDeserializer
            extends JsonDeserializer<CheckBottom> {

        @Override
        public CheckBottom deserialize(JsonParser jp, DeserializationContext ctxt)

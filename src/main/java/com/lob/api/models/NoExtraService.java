...
public class NoExtraService {
    ...
    private OptionalNullable<List<Buckslip>> buckslips;
     ...
     * @param  buckslips  List of Buckslip value for buckslips.
    ...
    protected NoExtraService(boolean color, Address to, String carrier, Address from, String id,
            LtrUseTypeEnum useType, List<TrackingEventNormal> trackingEvents,
            OptionalNullable<List<Card>> cards, OptionalNullable<List<Buckslip>> buckslips,
    ...
    protected NoExtraService(
        ...
        this(color, to, carrier, from, id, useType, null, OptionalNullable.of(null),
                OptionalNullable.of(null), null, OptionalNullable.of(null), null,
                OptionalNullable.of(null), null, null, null, null, null, OptionalNullable.of(null),
                OptionalNullable.of(null), null, null, null, null, null, null, null, null,
                OptionalNullable.of(null), null, null, OptionalNullable.of(null), null);
        unsetCards();
        unsetBuckslips();
        unsetDescription();
        unsetMergeVariables();
     ...
     * @return Returns the Internal List of Buckslip
     */
    @JsonGetter("buckslips")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonSerialize(using = OptionalNullable.Serializer.class)
    protected OptionalNullable<List<Buckslip>> internalGetBuckslips() {
     ...
     * An array of buckslip(s) associated with a specific letter
     * @return Returns the List of Buckslip
     */
     ...
     * An array of buckslip(s) associated with a specific letter
     * @param buckslips Value for List of Buckslip
     */
    ...
    public String toString() {
        return "NoExtraService [" + "color=" + color + ", to=" + to + ", carrier=" + carrier
                + ", from=" + from + ", id=" + id + ", useType=" + useType + ", trackingEvents="
                + trackingEvents + ", cards=" + cards + ", buckslips=" + buckslips
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(color, to, carrier, from, id, useType)
    ...
    public static class Builder {
         ...
         * @param  useType  LtrUseTypeEnum value for useType.
         */
        public Builder(boolean color, Address to, String carrier, Address from, String id,
                LtrUseTypeEnum useType) {
            this.color = color;
            this.to = to;
            this.carrier = carrier;
         ...
         * @return Builder
         */
        public Builder buckslips(List<Buckslip> buckslips) {
            this.buckslips = OptionalNullable.of(buckslips);
            return this;
        }
        ...
        public NoExtraService build() {
            return new NoExtraService(color, to, carrier, from, id, useType, trackingEvents, cards,
                    buckslips, returnAddress, description, metadata, mergeVariables, sendDate,
                    ...
                    deleted, url, templateId, templateVersionId, campaignId, fsc, status,

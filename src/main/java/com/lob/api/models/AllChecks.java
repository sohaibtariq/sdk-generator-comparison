...
public class AllChecks {
    ...
    protected AllChecks(String object, OptionalNullable<String> nextUrl,
    ...
    public String toString() {
        return "AllChecks [" + "object=" + object + ", nextUrl=" + nextUrl + ", previousUrl="
    ...
    public static class Builder {
        ...
        public AllChecks build() {
            return new AllChecks(object, nextUrl, previousUrl, count, totalCount, data);
        }
    }
}

...
/**
 * This is a model class for BuckslipsResponse type.
 */
public class BuckslipsResponse {
     ...
     * @param  data  List of Buckslip value for data.
     */
    public BuckslipsResponse(
            String object,
            String nextUrl,
    ...
    protected BuckslipsResponse(String object, OptionalNullable<String> nextUrl,
     ...
     * Setter for Data.
     * list of buckslips
     * @param data Value for List of Buckslip
     */
    @JsonSetter("data")
    ...
    /**
     * Converts this BuckslipsResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BuckslipsResponse [" + "object=" + object + ", nextUrl=" + nextUrl
                + ", previousUrl=" + previousUrl + ", count=" + count + ", totalCount=" + totalCount
                + ", data=" + data + "]";
    }

    /**
     * Builds a new {@link BuckslipsResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BuckslipsResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BuckslipsResponse}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder data(List<Buckslip> data) {
            this.data = data;
            return this;
        }

        /**
         * Builds a new {@link BuckslipsResponse} object using the set fields.
         * @return {@link BuckslipsResponse}
         */
        public BuckslipsResponse build() {
            return new BuckslipsResponse(object, nextUrl, previousUrl, count, totalCount, data);
        }
    }
}

...
| `Buckslips` | [`List<Buckslip>`](../../doc/models/buckslip.md) | Optional | An array of buckslip(s) associated with a specific letter | List<Buckslip> getBuckslips() | setBuckslips(List<Buckslip> buckslips) |

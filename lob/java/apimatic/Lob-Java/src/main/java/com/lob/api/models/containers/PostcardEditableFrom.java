 ...
 */
@JsonDeserialize(using = PostcardEditableFrom.PostcardEditableFromDeserializer.class)
public abstract class PostcardEditableFrom {
     ...
     */
    public static PostcardEditableFrom fromMString(String mString) {
    ...
    private static class MStringCase extends PostcardEditableFrom {
    ...
    private static class InlineAddressUsCase extends PostcardEditableFrom {
    ...
    /**
     * This is a custom deserializer class for PostcardEditableFrom.
     */
    protected static class PostcardEditableFromDeserializer
            extends JsonDeserializer<PostcardEditableFrom> {

        @Override
        public PostcardEditableFrom deserialize(JsonParser jp, DeserializationContext ctxt)

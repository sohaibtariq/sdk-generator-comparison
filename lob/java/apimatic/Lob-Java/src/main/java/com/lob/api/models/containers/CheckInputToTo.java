 ...
 */
@JsonDeserialize(using = CheckInputToTo.CheckInputToToDeserializer.class)
public abstract class CheckInputToTo {
     ...
     */
    public static CheckInputToTo fromMString(String mString) {
     ...
     */
    public static CheckInputToTo fromInlineAddressUsChk(InlineAddressUsChk inlineAddressUsChk) {
    ...
    private static class MStringCase extends CheckInputToTo {
    ...
    private static class Case1 extends CheckInputToTo {
    ...
    /**
     * This is a custom deserializer class for CheckInputToTo.
     */
    protected static class CheckInputToToDeserializer
            extends JsonDeserializer<CheckInputToTo> {

        @Override
        public CheckInputToTo deserialize(JsonParser jp, DeserializationContext ctxt)

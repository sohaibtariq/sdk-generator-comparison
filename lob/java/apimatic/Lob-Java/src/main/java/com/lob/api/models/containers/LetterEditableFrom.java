 ...
 */
@JsonDeserialize(using = LetterEditableFrom.LetterEditableFromDeserializer.class)
public abstract class LetterEditableFrom {
     ...
     */
    public static LetterEditableFrom fromMString(String mString) {
    ...
    private static class MStringCase extends LetterEditableFrom {
    ...
    private static class Case1 extends LetterEditableFrom {
    ...
    /**
     * This is a custom deserializer class for LetterEditableFrom.
     */
    protected static class LetterEditableFromDeserializer
            extends JsonDeserializer<LetterEditableFrom> {

        @Override
        public LetterEditableFrom deserialize(JsonParser jp, DeserializationContext ctxt)

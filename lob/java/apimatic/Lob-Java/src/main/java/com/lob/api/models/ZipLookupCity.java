...
public class ZipLookupCity {
     ...
     * target="_blank"&gt;USPS default city&lt;/a&gt; (preferred city) of a ZIP code. There is only one
     * preferred city per ZIP code, which will always be in position 0 in the array of cities.

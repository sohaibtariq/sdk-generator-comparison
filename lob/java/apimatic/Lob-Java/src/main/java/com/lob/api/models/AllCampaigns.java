...
/**
 * This is a model class for AllCampaigns type.
 */
public class AllCampaigns {
     ...
     * @param  data  List of Campaign value for data.
     */
    public AllCampaigns(
            String object,
            String nextUrl,
    ...
    protected AllCampaigns(String object, OptionalNullable<String> nextUrl,
     ...
     * Getter for Data.
     * list of campaigns
     * @return Returns the List of Campaign
     */
    @JsonGetter("data")
    @JsonInclude(JsonInclude.Include.NON_NULL)
     ...
     * Setter for Data.
     * list of campaigns
     * @param data Value for List of Campaign
     */
    @JsonSetter("data")
    ...
    /**
     * Converts this AllCampaigns into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AllCampaigns [" + "object=" + object + ", nextUrl=" + nextUrl + ", previousUrl="
                + previousUrl + ", count=" + count + ", totalCount=" + totalCount + ", data=" + data
                + "]";
    }

    /**
     * Builds a new {@link AllCampaigns.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link AllCampaigns.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link AllCampaigns}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder data(List<Campaign> data) {
            this.data = data;
            return this;
        }

        /**
         * Builds a new {@link AllCampaigns} object using the set fields.
         * @return {@link AllCampaigns}
         */
        public AllCampaigns build() {
            return new AllCampaigns(object, nextUrl, previousUrl, count, totalCount, data);
        }
    }
}

...
public class AddressIntl {
    ...
    protected AddressIntl(LocalDateTime dateCreated, LocalDateTime dateModified, String object,
            ...
            OptionalNullable<String> email, Map<String, String> metadata,
    ...
    protected AddressIntl(
            ...
            @JsonProperty("address_country") AddressCountry1Enum addressCountry) {
        this(dateCreated, dateModified, object, id, name, company, addressLine1, addressCountry,
                null, OptionalNullable.of(null), OptionalNullable.of(null),

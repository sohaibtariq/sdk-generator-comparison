...
public class Certified {
    private ExtraService1Enum extraService;
    ...
    protected Certified(ExtraService1Enum extraService, List<TrackingEventCertified> trackingEvents,
            boolean color, Address to, String carrier, Address from, String id,
            LtrUseTypeEnum useType, OptionalNullable<String> trackingNumber,
    ...
    @JsonCreator
    protected Certified(
            @JsonProperty("extra_service") ExtraService1Enum extraService,
            @JsonProperty("tracking_events") List<TrackingEventCertified> trackingEvents,
        ...
        this(extraService, trackingEvents, color, to, carrier, from, id, useType,
     ...
     * costs incurred. * `certified` - track and confirm delivery for domestic destinations. An
     * extra sheet (1 PDF page single-sided or 2 PDF pages double-sided) is added to the beginning
     * of your letter for address and barcode information. See here for templates: &lt;a
    ...
    public String toString() {
        return "Certified [" + "extraService=" + extraService + ", trackingEvents=" + trackingEvents
                ...
                + ", id=" + id + ", useType=" + useType + ", trackingNumber=" + trackingNumber
    ...
    public static class Builder {
         ...
         * @param  useType  LtrUseTypeEnum value for useType.
         */
        public Builder(ExtraService1Enum extraService, List<TrackingEventCertified> trackingEvents,
                boolean color, Address to, String carrier, Address from, String id,
                LtrUseTypeEnum useType) {
            this.extraService = extraService;
            this.trackingEvents = trackingEvents;
        ...
        public Certified build() {
            return new Certified(extraService, trackingEvents, color, to, carrier, from, id,
                    useType, trackingNumber, returnAddress, description, metadata, mergeVariables,
                    sendDate, mailType, doubleSided, addressPlacement, returnEnvelope,
                    perforatedPage, customEnvelope, thumbnails, expectedDeliveryDate, dateCreated,
                    dateModified, deleted, url, templateId, templateVersionId, campaignId, fsc,
                    status, failureReason, object);
        }
    }
}

 ...
 */
@JsonDeserialize(using = CardEditableBack.CardEditableBackDeserializer.class)
public abstract class CardEditableBack {
     ...
     */
    public static CardEditableBack fromMString(String mString) {
    ...
    private static class MStringCase extends CardEditableBack {
    ...
    /**
     * This is a custom deserializer class for CardEditableBack.
     */
    protected static class CardEditableBackDeserializer
            extends JsonDeserializer<CardEditableBack> {

        @Override
        public CardEditableBack deserialize(JsonParser jp, DeserializationContext ctxt)

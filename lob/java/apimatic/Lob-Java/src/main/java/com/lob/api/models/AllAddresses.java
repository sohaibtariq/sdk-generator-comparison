...
public class AllAddresses {
     ...
     * @param  data  List of Address value for data.
     */
    public AllAddresses(
            String object,
            String nextUrl,
     ...
     * Setter for Data.
     * list of addresses
     * @param data Value for List of Address
     */
    @JsonSetter("data")
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder data(List<Address> data) {
            this.data = data;
            return this;
        }
        ...
        public AllAddresses build() {
            return new AllAddresses(object, nextUrl, previousUrl, count, totalCount, data);
        }
    }
}

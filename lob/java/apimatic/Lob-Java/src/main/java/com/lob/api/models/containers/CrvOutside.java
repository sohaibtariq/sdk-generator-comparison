 ...
 */
@JsonDeserialize(using = CrvOutside.CrvOutsideDeserializer.class)
public abstract class CrvOutside {
     ...
     */
    public static CrvOutside fromMString(String mString) {
    ...
    private static class MStringCase extends CrvOutside {
    ...
    /**
     * This is a custom deserializer class for CrvOutside.
     */
    protected static class CrvOutsideDeserializer
            extends JsonDeserializer<CrvOutside> {

        @Override
        public CrvOutside deserialize(JsonParser jp, DeserializationContext ctxt)

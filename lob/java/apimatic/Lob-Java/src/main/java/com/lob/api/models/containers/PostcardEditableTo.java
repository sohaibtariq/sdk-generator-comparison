 ...
 */
@JsonDeserialize(using = PostcardEditableTo.PostcardEditableToDeserializer.class)
public abstract class PostcardEditableTo {
     ...
     */
    public static PostcardEditableTo fromMString(String mString) {
    ...
    private static class MStringCase extends PostcardEditableTo {
    ...
    private static class Case1 extends PostcardEditableTo {
    ...
    /**
     * This is a custom deserializer class for PostcardEditableTo.
     */
    protected static class PostcardEditableToDeserializer
            extends JsonDeserializer<PostcardEditableTo> {

        @Override
        public PostcardEditableTo deserialize(JsonParser jp, DeserializationContext ctxt)

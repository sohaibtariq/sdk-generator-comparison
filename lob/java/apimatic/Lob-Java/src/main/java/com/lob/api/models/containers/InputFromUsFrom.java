 ...
 */
@JsonDeserialize(using = InputFromUsFrom.InputFromUsFromDeserializer.class)
public abstract class InputFromUsFrom {
     ...
     */
    public static InputFromUsFrom fromMString(String mString) {
    ...
    private static class MStringCase extends InputFromUsFrom {
    ...
    private static class InlineAddressUsCase extends InputFromUsFrom {
    ...
    /**
     * This is a custom deserializer class for InputFromUsFrom.
     */
    protected static class InputFromUsFromDeserializer
            extends JsonDeserializer<InputFromUsFrom> {

        @Override
        public InputFromUsFrom deserialize(JsonParser jp, DeserializationContext ctxt)

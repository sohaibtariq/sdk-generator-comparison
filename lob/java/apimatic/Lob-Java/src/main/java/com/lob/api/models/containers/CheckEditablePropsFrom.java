 ...
 */
@JsonDeserialize(using = CheckEditablePropsFrom.CheckEditablePropsFromDeserializer.class)
public abstract class CheckEditablePropsFrom {
     ...
     */
    public static CheckEditablePropsFrom fromMString(String mString) {
    ...
    private static class MStringCase extends CheckEditablePropsFrom {
    ...
    private static class InlineAddressUsCase extends CheckEditablePropsFrom {
    ...
    /**
     * This is a custom deserializer class for CheckEditablePropsFrom.
     */
    protected static class CheckEditablePropsFromDeserializer
            extends JsonDeserializer<CheckEditablePropsFrom> {

        @Override
        public CheckEditablePropsFrom deserialize(JsonParser jp, DeserializationContext ctxt)

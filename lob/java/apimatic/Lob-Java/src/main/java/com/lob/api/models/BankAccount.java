...
public class BankAccount {
    ...
    protected BankAccount(String routingNumber, String accountNumber, AccountTypeEnum accountType,
            ...
            String id, OptionalNullable<String> description, CheckTemplateEnum checkTemplate,
            String fractionalRoutingNumber, String city, String state, String zipcode,
            Map<String, String> metadata, Boolean deleted, OptionalNullable<String> signatureUrl,
            String bankName, Boolean verified) {
    ...
    public String toString() {
        return "BankAccount [" + "routingNumber=" + routingNumber + ", accountNumber="
                ...
                + object + ", id=" + id + ", description=" + description + ", checkTemplate="
                + checkTemplate + ", fractionalRoutingNumber=" + fractionalRoutingNumber + ", city="
                + city + ", state=" + state + ", zipcode=" + zipcode + ", metadata=" + metadata
    ...
    public static class Builder {
        ...
        public BankAccount build() {
            return new BankAccount(routingNumber, accountNumber, accountType, signatory,
                    dateCreated, dateModified, object, id, description, checkTemplate,
                    fractionalRoutingNumber, city, state, zipcode, metadata, deleted, signatureUrl,
                    bankName, verified);
        }
    }
}

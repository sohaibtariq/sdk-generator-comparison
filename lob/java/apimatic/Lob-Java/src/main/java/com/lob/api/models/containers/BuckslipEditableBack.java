 ...
 */
@JsonDeserialize(using = BuckslipEditableBack.BuckslipEditableBackDeserializer.class)
public abstract class BuckslipEditableBack {
     ...
     */
    public static BuckslipEditableBack fromMString(String mString) {
    ...
    private static class MStringCase extends BuckslipEditableBack {
    ...
    /**
     * This is a custom deserializer class for BuckslipEditableBack.
     */
    protected static class BuckslipEditableBackDeserializer
            extends JsonDeserializer<BuckslipEditableBack> {

        @Override
        public BuckslipEditableBack deserialize(JsonParser jp, DeserializationContext ctxt)

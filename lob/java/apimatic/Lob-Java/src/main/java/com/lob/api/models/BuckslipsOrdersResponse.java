...
/**
 * This is a model class for BuckslipsOrdersResponse type.
 */
public class BuckslipsOrdersResponse {
     ...
     * @param  data  List of BuckslipOrder value for data.
     */
    public BuckslipsOrdersResponse(
            String object,
            String nextUrl,
    ...
    protected BuckslipsOrdersResponse(String object, OptionalNullable<String> nextUrl,
     ...
     * Setter for Data.
     * List of buckslip orders
     * @param data Value for List of BuckslipOrder
     */
    @JsonSetter("data")
    ...
    /**
     * Converts this BuckslipsOrdersResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BuckslipsOrdersResponse [" + "object=" + object + ", nextUrl=" + nextUrl
                + ", previousUrl=" + previousUrl + ", count=" + count + ", totalCount=" + totalCount
                + ", data=" + data + "]";
    }

    /**
     * Builds a new {@link BuckslipsOrdersResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BuckslipsOrdersResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BuckslipsOrdersResponse}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder data(List<BuckslipOrder> data) {
            this.data = data;
            return this;
        }

        /**
         * Builds a new {@link BuckslipsOrdersResponse} object using the set fields.
         * @return {@link BuckslipsOrdersResponse}
         */
        public BuckslipsOrdersResponse build() {
            return new BuckslipsOrdersResponse(object, nextUrl, previousUrl, count, totalCount,
                    data);
        }
    }
}

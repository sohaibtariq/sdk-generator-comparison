 ...
 */
@JsonDeserialize(using = CheckEditablePropsTo.CheckEditablePropsToDeserializer.class)
public abstract class CheckEditablePropsTo {
     ...
     */
    public static CheckEditablePropsTo fromMString(String mString) {
     ...
     */
    public static CheckEditablePropsTo fromInlineAddressUsChk(
    ...
    private static class MStringCase extends CheckEditablePropsTo {
    ...
    private static class Case1 extends CheckEditablePropsTo {
    ...
    /**
     * This is a custom deserializer class for CheckEditablePropsTo.
     */
    protected static class CheckEditablePropsToDeserializer
            extends JsonDeserializer<CheckEditablePropsTo> {

        @Override
        public CheckEditablePropsTo deserialize(JsonParser jp, DeserializationContext ctxt)

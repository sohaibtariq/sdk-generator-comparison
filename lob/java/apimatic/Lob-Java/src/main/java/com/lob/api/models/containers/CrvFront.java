 ...
 */
@JsonDeserialize(using = CrvFront.CrvFrontDeserializer.class)
public abstract class CrvFront {
     ...
     */
    public static CrvFront fromMString(String mString) {
    ...
    private static class MStringCase extends CrvFront {
    ...
    /**
     * This is a custom deserializer class for CrvFront.
     */
    protected static class CrvFrontDeserializer
            extends JsonDeserializer<CrvFront> {

        @Override
        public CrvFront deserialize(JsonParser jp, DeserializationContext ctxt)

...
import com.lob.api.models.containers.WordsAtCheckBottomAttachment;
import com.lob.api.models.containers.WordsAtCheckBottomFrom;
import com.lob.api.models.containers.WordsAtCheckBottomLogo;
import com.lob.api.models.containers.WordsAtCheckBottomTo;
import io.apimatic.core.types.OptionalNullable;
import java.util.Map;

/**
 * This is a model class for WordsAtCheckBottom type.
 */
public class WordsAtCheckBottom {
    ...
    private WordsAtCheckBottomTo to;
    private WordsAtCheckBottomFrom from;
    private String bankAccount;
    private double amount;
    private WordsAtCheckBottomLogo logo;
    private CheckBottom checkBottom;
    private WordsAtCheckBottomAttachment attachment;
     ...
     * @param  to  WordsAtCheckBottomTo value for to.
     * @param  from  WordsAtCheckBottomFrom value for from.
     ...
     * @param  logo  WordsAtCheckBottomLogo value for logo.
     * @param  checkBottom  CheckBottom value for checkBottom.
     * @param  attachment  WordsAtCheckBottomAttachment value for attachment.
    ...
    public WordsAtCheckBottom(
            ...
            String memo,
            Integer checkNumber,
            WordsAtCheckBottomLogo logo,
            CheckBottom checkBottom,
            WordsAtCheckBottomAttachment attachment,
    ...
    protected WordsAtCheckBottom(String message, ChkUseTypeEnum useType, WordsAtCheckBottomTo to,
            WordsAtCheckBottomFrom from, String bankAccount, double amount,
            ...
            OptionalNullable<String> memo, Integer checkNumber, WordsAtCheckBottomLogo logo,
            CheckBottom checkBottom, WordsAtCheckBottomAttachment attachment,
            String billingGroupId) {
     ...
     */
    @JsonCreator
    protected WordsAtCheckBottom(
            @JsonProperty("message") String message,
            @JsonProperty("use_type") ChkUseTypeEnum useType,
            @JsonProperty("to") WordsAtCheckBottomTo to,
            @JsonProperty("from") WordsAtCheckBottomFrom from,
            @JsonProperty("bank_account") String bankAccount,
            @JsonProperty("amount") double amount) {
        this(message, useType, to, from, bankAccount, amount, OptionalNullable.of(null), null,
     ...
     * @return Returns the WordsAtCheckBottomTo
     */
    @JsonGetter("to")
    public WordsAtCheckBottomTo getTo() {
        return to;
    }
     ...
     * href="https://help.lob.com/print-and-mail/all-about-addresses" target="_blank"&gt;More about
     * verification of mailing addresses&lt;/a&gt;
     * @param to Value for WordsAtCheckBottomTo
     */
    @JsonSetter("to")
    public void setTo(WordsAtCheckBottomTo to) {
        this.to = to;
    }
     ...
     * @return Returns the WordsAtCheckBottomFrom
     */
    @JsonGetter("from")
    public WordsAtCheckBottomFrom getFrom() {
        return from;
    }
     ...
     * be an address ID or an inline object with correct address parameters. All addresses will be
     * standardized into uppercase without being modified by verification.
     * @param from Value for WordsAtCheckBottomFrom
     */
    @JsonSetter("from")
    public void setFrom(WordsAtCheckBottomFrom from) {
        this.from = from;
    }
     ...
     * @return Returns the WordsAtCheckBottomLogo
     */
    @JsonGetter("logo")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public WordsAtCheckBottomLogo getLogo() {
        return logo;
    }
     ...
     * upper-left corner of your check. Image requirements: * RGB or CMYK * square * minimum size:
     * 100px x 100px * transparent backgrond * `png` or `jpg`
     * @param logo Value for WordsAtCheckBottomLogo
     */
    @JsonSetter("logo")
    public void setLogo(WordsAtCheckBottomLogo logo) {
        this.logo = logo;
    }
     ...
     * @return Returns the WordsAtCheckBottomAttachment
     */
    @JsonGetter("attachment")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public WordsAtCheckBottomAttachment getAttachment() {
        return attachment;
    }
     ...
     * href="https://lob.com/pricing/print-mail#compare" target="_blank"&gt;pricing&lt;/a&gt; for extra costs
     * incurred. Need more help? Consult our [HTML examples](#section/HTML-Examples).
     * @param attachment Value for WordsAtCheckBottomAttachment
     */
    @JsonSetter("attachment")
    public void setAttachment(WordsAtCheckBottomAttachment attachment) {
        this.attachment = attachment;
    }
    ...
    /**
     * Converts this WordsAtCheckBottom into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "WordsAtCheckBottom [" + "message=" + message + ", useType=" + useType + ", to=" + to
                + ", from=" + from + ", bankAccount=" + bankAccount + ", amount=" + amount
                + ", description=" + description + ", metadata=" + metadata + ", mergeVariables="
                + mergeVariables + ", sendDate=" + sendDate + ", mailType=" + mailType + ", memo="
                + memo + ", checkNumber=" + checkNumber + ", logo=" + logo + ", checkBottom="
                + checkBottom + ", attachment=" + attachment + ", billingGroupId=" + billingGroupId
                + "]";
    }

    /**
     * Builds a new {@link WordsAtCheckBottom.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link WordsAtCheckBottom.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(message, useType, to, from, bankAccount, amount)
    ...
    /**
     * Class to build instances of {@link WordsAtCheckBottom}.
     */
    public static class Builder {
         ...
         * @param  amount  double value for amount.
         */
        public Builder(String message, ChkUseTypeEnum useType, WordsAtCheckBottomTo to,
                WordsAtCheckBottomFrom from, String bankAccount, double amount) {
            this.message = message;
            this.useType = useType;
            this.to = to;
         ...
         * @return Builder
         */
        public Builder to(WordsAtCheckBottomTo to) {
            this.to = to;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder from(WordsAtCheckBottomFrom from) {
            this.from = from;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder logo(WordsAtCheckBottomLogo logo) {
            this.logo = logo;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder attachment(WordsAtCheckBottomAttachment attachment) {
            this.attachment = attachment;
            return this;
        }
        ...
        /**
         * Builds a new {@link WordsAtCheckBottom} object using the set fields.
         * @return {@link WordsAtCheckBottom}
         */
        public WordsAtCheckBottom build() {
            return new WordsAtCheckBottom(message, useType, to, from, bankAccount, amount,
                    description, metadata, mergeVariables, sendDate, mailType, memo, checkNumber,
                    logo, checkBottom, attachment, billingGroupId);
        }
    }
}

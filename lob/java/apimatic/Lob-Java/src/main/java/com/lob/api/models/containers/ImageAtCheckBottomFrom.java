 ...
 */
@JsonDeserialize(using = ImageAtCheckBottomFrom.ImageAtCheckBottomFromDeserializer.class)
public abstract class ImageAtCheckBottomFrom {
     ...
     */
    public static ImageAtCheckBottomFrom fromMString(String mString) {
    ...
    private static class MStringCase extends ImageAtCheckBottomFrom {
    ...
    private static class InlineAddressUsCase extends ImageAtCheckBottomFrom {
    ...
    /**
     * This is a custom deserializer class for ImageAtCheckBottomFrom.
     */
    protected static class ImageAtCheckBottomFromDeserializer
            extends JsonDeserializer<ImageAtCheckBottomFrom> {

        @Override
        public ImageAtCheckBottomFrom deserialize(JsonParser jp, DeserializationContext ctxt)

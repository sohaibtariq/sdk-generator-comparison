 ...
 */
@JsonDeserialize(using = WordsAtCheckBottomTo.WordsAtCheckBottomToDeserializer.class)
public abstract class WordsAtCheckBottomTo {
     ...
     */
    public static WordsAtCheckBottomTo fromMString(String mString) {
     ...
     */
    public static WordsAtCheckBottomTo fromInlineAddressUsChk(
    ...
    private static class MStringCase extends WordsAtCheckBottomTo {
    ...
    private static class Case1 extends WordsAtCheckBottomTo {
    ...
    /**
     * This is a custom deserializer class for WordsAtCheckBottomTo.
     */
    protected static class WordsAtCheckBottomToDeserializer
            extends JsonDeserializer<WordsAtCheckBottomTo> {

        @Override
        public WordsAtCheckBottomTo deserialize(JsonParser jp, DeserializationContext ctxt)

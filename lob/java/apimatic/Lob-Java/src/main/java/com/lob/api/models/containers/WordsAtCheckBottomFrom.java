 ...
 */
@JsonDeserialize(using = WordsAtCheckBottomFrom.WordsAtCheckBottomFromDeserializer.class)
public abstract class WordsAtCheckBottomFrom {
     ...
     */
    public static WordsAtCheckBottomFrom fromMString(String mString) {
    ...
    private static class MStringCase extends WordsAtCheckBottomFrom {
    ...
    private static class InlineAddressUsCase extends WordsAtCheckBottomFrom {
    ...
    /**
     * This is a custom deserializer class for WordsAtCheckBottomFrom.
     */
    protected static class WordsAtCheckBottomFromDeserializer
            extends JsonDeserializer<WordsAtCheckBottomFrom> {

        @Override
        public WordsAtCheckBottomFrom deserialize(JsonParser jp, DeserializationContext ctxt)

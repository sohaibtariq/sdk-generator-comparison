...
import com.lob.api.models.containers.IntlVerificationsAddresses;
...
public class IntlVerifications {
    private List<IntlVerificationsAddresses> addresses;
     ...
     * @param  addresses  List of IntlVerificationsAddresses value for addresses.
     ...
     * @return Returns the List of IntlVerificationsAddresses
     */
    @JsonGetter("addresses")
    public List<IntlVerificationsAddresses> getAddresses() {
        return addresses;
    }

    /**
     * Setter for Addresses.
     * @param addresses Value for List of IntlVerificationsAddresses
     */
    @JsonSetter("addresses")
    public void setAddresses(List<IntlVerificationsAddresses> addresses) {
        this.addresses = addresses;
    }
    ...
    public static class Builder {
         ...
         * @param  errors  boolean value for errors.
         */
        public Builder(List<IntlVerificationsAddresses> addresses, boolean errors) {
            this.addresses = addresses;
            this.errors = errors;
        }
         ...
         * @return Builder
         */
        public Builder addresses(List<IntlVerificationsAddresses> addresses) {
            this.addresses = addresses;
            return this;
        }

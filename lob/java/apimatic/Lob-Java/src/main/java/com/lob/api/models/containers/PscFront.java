 ...
 */
@JsonDeserialize(using = PscFront.PscFrontDeserializer.class)
public abstract class PscFront {
     ...
     */
    public static PscFront fromMString(String mString) {
    ...
    private static class MStringCase extends PscFront {
    ...
    /**
     * This is a custom deserializer class for PscFront.
     */
    protected static class PscFrontDeserializer
            extends JsonDeserializer<PscFront> {

        @Override
        public PscFront deserialize(JsonParser jp, DeserializationContext ctxt)

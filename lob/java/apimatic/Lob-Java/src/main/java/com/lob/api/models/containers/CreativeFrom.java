 ...
 */
@JsonDeserialize(using = CreativeFrom.CreativeFromDeserializer.class)
public abstract class CreativeFrom {
     ...
     */
    public static CreativeFrom fromMString(String mString) {
    ...
    private static class MStringCase extends CreativeFrom {
    ...
    private static class InlineAddressUsCase extends CreativeFrom {
    ...
    /**
     * This is a custom deserializer class for CreativeFrom.
     */
    protected static class CreativeFromDeserializer
            extends JsonDeserializer<CreativeFrom> {

        @Override
        public CreativeFrom deserialize(JsonParser jp, DeserializationContext ctxt)

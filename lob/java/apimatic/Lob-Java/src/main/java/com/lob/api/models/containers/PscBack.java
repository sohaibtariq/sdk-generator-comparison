 ...
 */
@JsonDeserialize(using = PscBack.PscBackDeserializer.class)
public abstract class PscBack {
     ...
     */
    public static PscBack fromMString(String mString) {
    ...
    private static class MStringCase extends PscBack {
    ...
    /**
     * This is a custom deserializer class for PscBack.
     */
    protected static class PscBackDeserializer
            extends JsonDeserializer<PscBack> {

        @Override
        public PscBack deserialize(JsonParser jp, DeserializationContext ctxt)

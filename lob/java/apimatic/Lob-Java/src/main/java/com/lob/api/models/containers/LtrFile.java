 ...
 */
@JsonDeserialize(using = LtrFile.LtrFileDeserializer.class)
public abstract class LtrFile {
     ...
     */
    public static LtrFile fromMString(String mString) {
    ...
    private static class MStringCase extends LtrFile {
    ...
    /**
     * This is a custom deserializer class for LtrFile.
     */
    protected static class LtrFileDeserializer
            extends JsonDeserializer<LtrFile> {

        @Override
        public LtrFile deserialize(JsonParser jp, DeserializationContext ctxt)

 ...
 */
@JsonDeserialize(using = CrvFile.CrvFileDeserializer.class)
public abstract class CrvFile {
     ...
     */
    public static CrvFile fromMString(String mString) {
    ...
    private static class MStringCase extends CrvFile {
    ...
    /**
     * This is a custom deserializer class for CrvFile.
     */
    protected static class CrvFileDeserializer
            extends JsonDeserializer<CrvFile> {

        @Override
        public CrvFile deserialize(JsonParser jp, DeserializationContext ctxt)

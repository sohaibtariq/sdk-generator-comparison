...
/**
 * This is a model class for QrCode type.
 */
public class QrCode {
    ...
    /**
     * Converts this QrCode into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "QrCode [" + "position=" + position + ", redirectUrl=" + redirectUrl + ", width="
                + width + ", top=" + top + ", right=" + right + ", left=" + left + ", bottom="
                + bottom + ", pages=" + pages + "]";
    }

    /**
     * Builds a new {@link QrCode.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link QrCode.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(position, redirectUrl, width)
                .top(getTop())
                .right(getRight())
                .left(getLeft())
                .bottom(getBottom())
    ...
    /**
     * Class to build instances of {@link QrCode}.
     */
    public static class Builder {
         ...
         * @param  width  String value for width.
         */
        public Builder(String position, String redirectUrl, String width) {
            this.position = position;
            this.redirectUrl = redirectUrl;
            this.width = width;
        }
        ...
        /**
         * Builds a new {@link QrCode} object using the set fields.
         * @return {@link QrCode}
         */
        public QrCode build() {
            return new QrCode(position, redirectUrl, width, top, right, left, bottom, pages);
        }
    }
}

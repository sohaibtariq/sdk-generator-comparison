...
/**
 * This is a model class for ReturnedResource type.
 */
public class ReturnedResource {
    private String resourceType;
    private Returned details;
     ...
     * @param  details  Returned value for details.
    ...
    protected ReturnedResource(String resourceType, Returned details, FromAttribute from,
     ...
     * Properties that the postcards in your Creative should have. Check within in order to add a QR
     * code to your creative.
     * @param details Value for Returned
     */
    @JsonSetter("details")
    public void setDetails(Returned details) {
        this.details = details;
    }
    ...
    /**
     * Converts this ReturnedResource into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReturnedResource [" + "resourceType=" + resourceType + ", details=" + details
                + ", from=" + from + ", description=" + description + ", metadata=" + metadata
                + "]";
    }

    /**
     * Builds a new {@link ReturnedResource.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReturnedResource.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReturnedResource}.
     */
    public static class Builder {
         ...
         * @param  details  Returned value for details.
         */
        public Builder(String resourceType, Returned details) {
            this.resourceType = resourceType;
            this.details = details;
        }
         ...
         * @return Builder
         */
        public Builder details(Returned details) {
            this.details = details;
            return this;
        }
        ...
        /**
         * Builds a new {@link ReturnedResource} object using the set fields.
         * @return {@link ReturnedResource}
         */
        public ReturnedResource build() {
            return new ReturnedResource(resourceType, details, from, description, metadata);
        }
    }
}

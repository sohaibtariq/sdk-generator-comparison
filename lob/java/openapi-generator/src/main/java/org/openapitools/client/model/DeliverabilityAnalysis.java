...
public class DeliverabilityAnalysis {
  ...
  public enum DpvConfirmationEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      DpvConfirmationEnum.fromValue(value);
    }
  }
  ...
  public enum LacsIndicatorEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      LacsIndicatorEnum.fromValue(value);
    }
  }
  ...
  public enum SuiteReturnCodeEnum {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      String value = jsonElement.getAsString();
      SuiteReturnCodeEnum.fromValue(value);
    }
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to DeliverabilityAnalysis
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeliverabilityAnalysis.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeliverabilityAnalysis.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DeliverabilityAnalysis` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      // validate the required field `dpv_confirmation`
      DpvConfirmationEnum.validateJsonElement(jsonObj.get("dpv_confirmation"));
      ...
      // validate the required field `dpv_cmra`
      DpvCmraEnum.validateJsonElement(jsonObj.get("dpv_cmra"));
      ...
      // validate the required field `dpv_vacant`
      DpvVacantEnum.validateJsonElement(jsonObj.get("dpv_vacant"));
      ...
      // validate the required field `dpv_active`
      DpvActiveEnum.validateJsonElement(jsonObj.get("dpv_active"));
      ...
      // validate the required field `lacs_indicator`
      LacsIndicatorEnum.validateJsonElement(jsonObj.get("lacs_indicator"));
      ...
      // validate the required field `suite_return_code`
      SuiteReturnCodeEnum.validateJsonElement(jsonObj.get("suite_return_code"));
  }

...
public class TemplateWritable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(description, html, metadata, engine, requiredVars);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to TemplateWritable
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TemplateWritable.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TemplateWritable.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TemplateWritable` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

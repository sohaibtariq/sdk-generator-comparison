...
public class CompanyValidation {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, company, primaryLine, secondaryLine, urbanization, lastLine, score, confidence, _object);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CompanyValidation
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CompanyValidation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CompanyValidation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CompanyValidation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

...
public class CampaignItem {
  ...
  **/
  ...
  public CampaignItem creatives(List<String> creatives) {
    
    this.creatives = creatives;
    return this;
  }

  public CampaignItem addCreativesItem(String creativesItem) {
  ...
  **/
  ...
  public CampaignItem uploads(List<String> uploads) {
    
    this.uploads = uploads;
    return this;
  }

  public CampaignItem addUploadsItem(String uploadsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.billingGroupId, campaignItem.billingGroupId) &&
        Objects.equals(this.name, campaignItem.name) &&
        Objects.equals(this.description, campaignItem.description) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingGroupId, name, description, scheduleType, targetDeliveryDate, sendDate, cancelWindowCampaignMinutes, metadata, useType, autoCancelIfNcoa, id, isDraft, creatives, uploads, _object, dateCreated, dateModified, deleted);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to CampaignItem
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CampaignItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CampaignItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CampaignItem` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("creatives") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("creatives").isJsonArray()) {
      ...
      // ensure the required json array is present
      if (jsonObj.get("uploads") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("uploads").isJsonArray()) {

...
public class PostcardsApi {
    ...
    private okhttp3.Call postcardCreateValidateBeforeCall(PostcardEditable postcardEditable, String idempotencyKey, final ApiCallback _callback) throws ApiException {
        ...
        return postcardCreateCall(postcardEditable, idempotencyKey, _callback);
    ...
    private okhttp3.Call postcardDeleteValidateBeforeCall(String pscId, final ApiCallback _callback) throws ApiException {
        ...
        return postcardDeleteCall(pscId, _callback);
    ...
    private okhttp3.Call postcardRetrieveValidateBeforeCall(String pscId, final ApiCallback _callback) throws ApiException {
        ...
        return postcardRetrieveCall(pscId, _callback);
     ...
     */
    public okhttp3.Call postcardsListCall(Integer limit, AddressesListBeforeAfterParameter beforeAfter, List<String> include, Map<String, String> dateCreated, Map<String, String> metadata, List<PostcardSize> size, Boolean scheduled, SendDate sendDate, MailType mailType, ChecksListSortByParameter sortBy, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postcardsListValidateBeforeCall(Integer limit, AddressesListBeforeAfterParameter beforeAfter, List<String> include, Map<String, String> dateCreated, Map<String, String> metadata, List<PostcardSize> size, Boolean scheduled, SendDate sendDate, MailType mailType, ChecksListSortByParameter sortBy, final ApiCallback _callback) throws ApiException {
        return postcardsListCall(limit, beforeAfter, include, dateCreated, metadata, size, scheduled, sendDate, mailType, sortBy, _callback);
     ...
     * @param mailType A string designating the mail postage type: * &#x60;usps_first_class&#x60; - (default) * &#x60;usps_standard&#x60; - a &lt;a href&#x3D;\&quot;https://lob.com/pricing/print-mail#compare\&quot; target&#x3D;\&quot;_blank\&quot;&gt;cheaper option&lt;/a&gt; which is less predictable and takes longer to deliver. &#x60;usps_standard&#x60; cannot be used with &#x60;4x6&#x60; postcards or for any postcards sent outside of the United States.  (optional, default to usps_first_class)
     * @param sortBy Sorts items by ascending or descending dates. Use either &#x60;date_created&#x60; or &#x60;send_date&#x60;, not both.  (optional)
     * @return PostcardsList200Response
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public PostcardsList200Response postcardsList(Integer limit, AddressesListBeforeAfterParameter beforeAfter, List<String> include, Map<String, String> dateCreated, Map<String, String> metadata, List<PostcardSize> size, Boolean scheduled, SendDate sendDate, MailType mailType, ChecksListSortByParameter sortBy) throws ApiException {
        ApiResponse<PostcardsList200Response> localVarResp = postcardsListWithHttpInfo(limit, beforeAfter, include, dateCreated, metadata, size, scheduled, sendDate, mailType, sortBy);
        return localVarResp.getData();
    }
     ...
     * @param mailType A string designating the mail postage type: * &#x60;usps_first_class&#x60; - (default) * &#x60;usps_standard&#x60; - a &lt;a href&#x3D;\&quot;https://lob.com/pricing/print-mail#compare\&quot; target&#x3D;\&quot;_blank\&quot;&gt;cheaper option&lt;/a&gt; which is less predictable and takes longer to deliver. &#x60;usps_standard&#x60; cannot be used with &#x60;4x6&#x60; postcards or for any postcards sent outside of the United States.  (optional, default to usps_first_class)
     * @param sortBy Sorts items by ascending or descending dates. Use either &#x60;date_created&#x60; or &#x60;send_date&#x60;, not both.  (optional)
     * @return ApiResponse&lt;PostcardsList200Response&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PostcardsList200Response> postcardsListWithHttpInfo(Integer limit, AddressesListBeforeAfterParameter beforeAfter, List<String> include, Map<String, String> dateCreated, Map<String, String> metadata, List<PostcardSize> size, Boolean scheduled, SendDate sendDate, MailType mailType, ChecksListSortByParameter sortBy) throws ApiException {
        okhttp3.Call localVarCall = postcardsListValidateBeforeCall(limit, beforeAfter, include, dateCreated, metadata, size, scheduled, sendDate, mailType, sortBy, null);
        Type localVarReturnType = new TypeToken<PostcardsList200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call postcardsListAsync(Integer limit, AddressesListBeforeAfterParameter beforeAfter, List<String> include, Map<String, String> dateCreated, Map<String, String> metadata, List<PostcardSize> size, Boolean scheduled, SendDate sendDate, MailType mailType, ChecksListSortByParameter sortBy, final ApiCallback<PostcardsList200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = postcardsListValidateBeforeCall(limit, beforeAfter, include, dateCreated, metadata, size, scheduled, sendDate, mailType, sortBy, _callback);
        Type localVarReturnType = new TypeToken<PostcardsList200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

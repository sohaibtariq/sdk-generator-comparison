...
public class CampaignWritable {
    ...
    public CampaignWritable withBillingGroupId(String billingGroupId) {
    ...
    public CampaignWritable withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CampaignWritable withDescription(String description) {
    ...
    public CampaignWritable withScheduleType(CmpScheduleType scheduleType) {
    ...
    public CampaignWritable withTargetDeliveryDate(OffsetDateTime targetDeliveryDate) {
    ...
    public CampaignWritable withSendDate(OffsetDateTime sendDate) {
    ...
    public CampaignWritable withCancelWindowCampaignMinutes(Long cancelWindowCampaignMinutes) {
    ...
    public CampaignWritable withMetadata(java.util.Map<String, String> metadata) {
    ...
    public CampaignWritable withUseType(CmpUseType useType) {
    ...
    public CampaignWritable withAutoCancelIfNcoa(Boolean autoCancelIfNcoa) {
        this.autoCancelIfNcoa = autoCancelIfNcoa;
        return this;
    }
    
    public CampaignWritable(@JsonProperty("name") String name, @JsonProperty("schedule_type") CmpScheduleType scheduleType, @JsonProperty("use_type") CmpUseType useType) {
        this.name = name;
        this.scheduleType = scheduleType;
        this.useType = useType;
  }

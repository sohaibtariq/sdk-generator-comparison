...
public class Postcard {
    ...
    public Postcard withTo(Object to) {
        this.to = to;
        return this;
    }
    ...
    public PostcardCarrier carrier;

    public Postcard withCarrier(PostcardCarrier carrier) {
    ...
    public Postcard withThumbnails(Thumbnail[] thumbnails) {
    ...
    public Postcard withExpectedDeliveryDate(LocalDate expectedDeliveryDate) {
    ...
    public Postcard withDateCreated(OffsetDateTime dateCreated) {
    ...
    public Postcard withDateModified(OffsetDateTime dateModified) {
    ...
    public Postcard withDeleted(Boolean deleted) {
    ...
    public Postcard withFrom(Object from) {
        this.from = from;
        return this;
    }
    ...
    public Postcard withId(String id) {
        this.id = id;
        return this;
    }
     ...
     */
    @JsonProperty("front_template_id")
    public String frontTemplateId;

    public Postcard withFrontTemplateId(String frontTemplateId) {
     ...
     */
    @JsonProperty("back_template_id")
    public String backTemplateId;

    public Postcard withBackTemplateId(String backTemplateId) {
    ...
    public Postcard withFrontTemplateVersionId(String frontTemplateVersionId) {
    ...
    public Postcard withBackTemplateVersionId(String backTemplateVersionId) {
    ...
    public Postcard withTrackingEvents(TrackingEventNormal[] trackingEvents) {
    ...
    public Postcard withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public Postcard withCampaignId(String campaignId) {
    ...
    public PscUseType useType;

    public Postcard withUseType(PscUseType useType) {
    ...
    public Postcard withFsc(Boolean fsc) {
        this.fsc = fsc;
        return this;
    }
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("status")
    public TheStatusOfThePostcard status;

    public Postcard withStatus(TheStatusOfThePostcard status) {
        this.status = status;
        return this;
    }
    ...
    public Postcard withFailureReason(String failureReason) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("object")
    public PostcardObject object;

    public Postcard withObject(PostcardObject object) {
        this.object = object;
        return this;
    }
    ...
    public Postcard withDescription(String description) {
    ...
    public Postcard withMetadata(java.util.Map<String, String> metadata) {
    ...
    public Postcard withMailType(MailType mailType) {
    ...
    public Postcard withMergeVariables(MergeVariables mergeVariables) {
    ...
    public Postcard withSendDate(Object sendDate) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("size")
    public PostcardSize size;

    public Postcard withSize(PostcardSize size) {
        this.size = size;
        return this;
    }
    
    public Postcard(@JsonProperty("to") Object to, @JsonProperty("id") String id, @JsonProperty("front_template_id") String frontTemplateId, @JsonProperty("back_template_id") String backTemplateId, @JsonProperty("url") String url) {
        this.to = to;
        this.id = id;
        this.frontTemplateId = frontTemplateId;
        this.backTemplateId = backTemplateId;

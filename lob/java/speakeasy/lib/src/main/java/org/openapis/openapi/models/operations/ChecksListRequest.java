...
public class ChecksListRequest {
    /**
    ...
    public ChecksListRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ChecksListRequest withBeforeAfter(Object beforeAfter) {
    ...
    public ChecksListRequest withInclude(String[] include) {
    ...
    public ChecksListRequest withDateCreated(java.util.Map<String, String> dateCreated) {
    ...
    public ChecksListRequest withMetadata(java.util.Map<String, String> metadata) {
    ...
    public ChecksListRequest withScheduled(Boolean scheduled) {
    ...
    public ChecksListRequest withSendDate(Object sendDate) {
    ...
    public ChecksListRequest withMailType(org.openapis.openapi.models.shared.MailType mailType) {
    ...
    public ChecksListRequest withSortBy(Object sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    
    public ChecksListRequest(){}
}

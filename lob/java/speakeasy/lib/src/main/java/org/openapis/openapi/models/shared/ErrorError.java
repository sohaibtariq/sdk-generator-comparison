...
public class ErrorError {
    ...
    public FailureStatusCode statusCode;

    public ErrorError withStatusCode(FailureStatusCode statusCode) {
    ...
    public ErrorError withCode(Code code) {
        this.code = code;
        return this;
    }
    
    public ErrorError(@JsonProperty("message") String message, @JsonProperty("status_code") FailureStatusCode statusCode, @JsonProperty("code") Code code) {
        this.message = message;
        this.statusCode = statusCode;
        this.code = code;
  }

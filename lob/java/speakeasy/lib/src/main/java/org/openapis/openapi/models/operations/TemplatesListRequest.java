...
public class TemplatesListRequest {
    ...
    public TemplatesListRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public TemplatesListRequest withBeforeAfter(Object beforeAfter) {
    ...
    public TemplatesListRequest withInclude(String[] include) {
    ...
    public TemplatesListRequest withDateCreated(java.util.Map<String, String> dateCreated) {
    ...
    public TemplatesListRequest withMetadata(java.util.Map<String, String> metadata) {
        this.metadata = metadata;
        return this;
    }
    
    public TemplatesListRequest(){}
}

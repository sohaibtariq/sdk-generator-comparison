...
/**
 * IntlVerificationStatus - The status level for the country. This represents the maximum level of
 ...
 * 
 */
public enum IntlVerificationStatus {
    LV4("LV4"),
    LV3("LV3"),
    LV2("LV2"),
    LV1("LV1"),
    ...
    private IntlVerificationStatus(String value) {
        this.value = value;
    }
}

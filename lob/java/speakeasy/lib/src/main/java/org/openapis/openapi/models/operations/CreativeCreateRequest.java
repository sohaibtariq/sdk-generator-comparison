...
public class CreativeCreateRequest {
    ...
    public CreativeCreateRequest withRequestBody(Object requestBody) {
    ...
    public CreativeCreateRequest withXLangOutput(org.openapis.openapi.models.shared.LangSpec xLangOutput) {
        this.xLangOutput = xLangOutput;
        return this;
    }
    
    public CreativeCreateRequest(@JsonProperty("RequestBody") Object requestBody) {
        this.requestBody = requestBody;
  }
}

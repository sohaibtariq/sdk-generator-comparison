...
public class TemplateVersion {
    ...
    public TemplateVersion withHtml(String html) {
        this.html = html;
        return this;
    }
    ...
    public TemplateVersion withEngine(Engine engine) {
        this.engine = engine;
        return this;
    }
    ...
    public TemplateVersion withRequiredVars(String[] requiredVars) {
    ...
    public TemplateVersion withDateCreated(OffsetDateTime dateCreated) {
    ...
    public TemplateVersion withDateModified(OffsetDateTime dateModified) {
    ...
    public TemplateVersion withDeleted(Boolean deleted) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("object")
    public TemplateVersionObject object;

    public TemplateVersion withObject(TemplateVersionObject object) {
        this.object = object;
        return this;
    }
    ...
    public TemplateVersion withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public TemplateVersion withSuggestJsonEditor(Boolean suggestJsonEditor) {
    ...
    public TemplateVersionMergeVariables mergeVariables;

    public TemplateVersion withMergeVariables(TemplateVersionMergeVariables mergeVariables) {
        this.mergeVariables = mergeVariables;
        return this;
    }
    
    public TemplateVersion(@JsonProperty("html") String html, @JsonProperty("date_created") OffsetDateTime dateCreated, @JsonProperty("date_modified") OffsetDateTime dateModified, @JsonProperty("id") String id) {
        this.html = html;
        this.dateCreated = dateCreated;
        this.dateModified = dateModified;
        this.id = id;

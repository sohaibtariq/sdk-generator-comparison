...
public class BaseControllerTest {
     ...
     */
    protected static PetstoreExtendedClient createConfigurationFromEnvironment() {
        PetstoreExtendedClient.Builder builder = new PetstoreExtendedClient.Builder();

        final String environment = System.getenv("PETSTORE_EXTENDED_LIB_ENVIRONMENT");
        final String timeout = System.getenv("PETSTORE_EXTENDED_LIB_TIMEOUT");
        final String apiKey = System.getenv("PETSTORE_EXTENDED_LIB_API_KEY");
     ...
     */
    protected static PetstoreExtendedClient createConfiguration() {
        // Set Configuration parameters for test execution
        PetstoreExtendedClient config = createConfigurationFromEnvironment();

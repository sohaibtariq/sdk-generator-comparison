...
| `OutsideTemplateId` | `String` | Optional | The unique ID of the HTML template used for the outside of the self mailer.<br>**Constraints**: *Pattern*: `^tmpl_[a-zA-Z0-9]+$` | String getOutsideTemplateId() | setOutsideTemplateId(String outsideTemplateId) |
| `InsideTemplateId` | `String` | Optional | The unique ID of the HTML template used for the inside of the self mailer.<br>**Constraints**: *Pattern*: `^tmpl_[a-zA-Z0-9]+$` | String getInsideTemplateId() | setInsideTemplateId(String insideTemplateId) |
